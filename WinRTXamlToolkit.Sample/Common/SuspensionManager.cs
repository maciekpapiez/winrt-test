...
namespace WinRTXamlToolkit.Sample.Common
{
    ...
    internal sealed class SuspensionManager
    {
        ...
        /// <summary>
        /// Save the current <see cref="SessionState"/>.  Any <see cref="AlternativeFrame"/> instances
        ...
        /// <summary>
        /// Restores previously saved <see cref="SessionState"/>.  Any <see cref="AlternativeFrame"/> instances
        ...
        private static List<WeakReference<AlternativeFrame>> _registeredFrames = new List<WeakReference<AlternativeFrame>>();
